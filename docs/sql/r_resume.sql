...
CREATE TABLE `r_resume`  (
  ...
  `sex` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '性别',
  `birthday` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '出生日期',
  `workYear` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '工作年限',
  ...
  `status` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '目前状态',
  `resumeName` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '简历名称',
  ...
  `headPic` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '头像',
  `isDel` int(2) NULL DEFAULT NULL COMMENT '是否删除 默认值0-未删除 1-已删除',
  `updateTime` datetime(0) NULL DEFAULT NULL COMMENT '简历更新时间',
  `userId` int(11) NULL DEFAULT NULL COMMENT '用户ID',
  `isDefault` int(2) NULL DEFAULT NULL COMMENT '是否为默认简历 0-默认 1-非默认',
  `highestEducation` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '' COMMENT '最高学历',
  `deliverNearByConfirm` int(2) NULL DEFAULT 0 COMMENT '投递附件简历确认 0-需要确认 1-不需要确认',
  ...
  `oneWord` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '' COMMENT '一句话介绍自己',
  `liveCity` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '' COMMENT '居住城市',
  `resumeScore` int(3) NULL DEFAULT NULL COMMENT '简历得分',
  `userIdentity` int(1) NULL DEFAULT 0 COMMENT '用户身份1-学生 2-工人',
  `isOpenResume` int(1) NULL DEFAULT 3 COMMENT '人才搜索-开放简历 0-关闭，1-打开，2-简历未达到投放标准被动关闭 3-从未设置过开放简历',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2195388 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
